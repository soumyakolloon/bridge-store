<?php /* Smarty version 2.6.26, created on 2015-01-29 16:56:59
         compiled from wysiwyg/popup_colorfore.html */ ?>
...
_colorfore_map"><?php $_from = $this->_tpl_vars['lists']['colors']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" onclick="return WysiwygCmdColorFore('<?php echo $this->_tpl_vars['id']; ?>
